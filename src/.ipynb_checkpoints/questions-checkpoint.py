...
# =============  QUESTIONS ==================
question_1_data = {'prompt': '### Which column produces the best split of the target class?',
                   'options': ['wood', 'metal', 'plastic', 'has_cap'],
                   'value': 'wood'}
...
question_1 = MultiChoice(question_1_data)
